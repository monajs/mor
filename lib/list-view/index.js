	...
	_createClass(ListView, [{
		...
		value: function scroll(e) {
			...
			this.timer = setTimeout(function () {
				...
				_this2.footerHeight = _this2.footerHeight || _this2.wrap.querySelector('.list-view-infinite').clientHeight;

				var bottom = _this2.sectionHeight - _this2.containerHeight - scrollTop - _this2.headerHeight;
				if (bottom < _this2.sectionHeight + bottomEmit) {
					_this2.infinite();
				}
